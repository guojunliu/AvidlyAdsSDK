...
@protocol OpenUpBannerWrapperProtocol;

@interface OpenUpBannerBaseWrapper : NSObject
 ...
 * 设置回调代理
 */
@property (nonatomic, weak) id<OpenUpBannerWrapperProtocol> delegate;

@end

@protocol OpenUpBannerWrapperProtocol <NSObject>
