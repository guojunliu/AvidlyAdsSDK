...
@protocol OpenUpIconDelegate;

@interface OpenUpIconWrapper : NSObject

@property (nonatomic,weak) id<OpenUpIconDelegate> delegate;
...
@protocol OpenUpIconDelegate <NSObject>
@optional
//Icon广告加载完成
